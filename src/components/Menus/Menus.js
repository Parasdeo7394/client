    ...
    {toggle ? (
        <>
          <Zoom>
            <div className="navbar-profile-pic">
                <img src="https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?cs=srgb&dl=pexels-pixabay-220453.jpg&fm=jpg" alt="profile pic" />
        ...
        <>
          ...
          <div className="nav-items">
            ...
            <div className="nav-item">
                <div className="nav-link"> <Link  to= 'work'spy={true} smooth={true}  offset={-100} duration={100}><FcPortraitMode title='Work Experience'/></Link></div>
            </div>
